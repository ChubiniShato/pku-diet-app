...
public class NormController {
    ...
    @Operation(summary = "Get all norms for a patient", description = "Retrieve all norm prescriptions for a specific patient")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved norm prescriptions",
                    content = @Content(mediaType = "application/json", schema = @Schema(implementation = NormPrescriptionDto.class)))
    })
    ...
    @Operation(summary = "Get active norms for a patient", description = "Retrieve all active norm prescriptions for a specific patient")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved active norm prescriptions",
                    content = @Content(mediaType = "application/json", schema = @Schema(implementation = NormPrescriptionDto.class)))
    })
    ...
    @Operation(summary = "Get current norm for a patient", description = "Retrieve the current active norm prescription for a specific patient")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved current norm prescription",
                    content = @Content(mediaType = "application/json", schema = @Schema(implementation = NormPrescriptionDto.class))),
    ...
    public ResponseEntity<NormPrescriptionDto> getCurrentNormForPatient(
        ...
        return currentNorm.map(ResponseEntity::ok)
                .orElse(ResponseEntity.notFound().build());
    }

    @Operation(summary = "Get norm prescription by ID", description = "Retrieve a specific norm prescription by its unique identifier")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved norm prescription",
                    content = @Content(mediaType = "application/json", schema = @Schema(implementation = NormPrescriptionDto.class))),
    ...
    @Operation(summary = "Create new norm prescription", description = "Create a new norm prescription for a patient")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "Norm prescription created successfully",
                    content = @Content(mediaType = "application/json", schema = @Schema(implementation = NormPrescriptionDto.class))),
    ...
    public ResponseEntity<NormPrescriptionDto> createNorm(
            ...
            @Valid @RequestBody CreateNormPrescriptionRequest request) {
    ...
    @Operation(summary = "Update norm prescription", description = "Update an existing norm prescription")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Norm prescription updated successfully",
                    content = @Content(mediaType = "application/json", schema = @Schema(implementation = NormPrescriptionDto.class))),
            @ApiResponse(responseCode = "404", description = "Norm prescription not found"),
            @ApiResponse(responseCode = "400", description = "Invalid request data")
    })
    ...
    @Operation(summary = "Activate norm prescription", description = "Activate a norm prescription and deactivate others for the same patient")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Norm prescription activated successfully",
                    content = @Content(mediaType = "application/json", schema = @Schema(implementation = NormPrescriptionDto.class))),
            @ApiResponse(responseCode = "404", description = "Norm prescription not found")
    })
    ...
    @Operation(summary = "Deactivate norm prescription", description = "Deactivate a norm prescription")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Norm prescription deactivated successfully",
                    content = @Content(mediaType = "application/json", schema = @Schema(implementation = NormPrescriptionDto.class))),
            @ApiResponse(responseCode = "404", description = "Norm prescription not found")
    })
