...
public class PatientController {
    ...
    @Operation(summary = "Get all patient profiles", description = "Retrieve all patient profiles with optional pagination")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved patient profiles",
                    content = @Content(mediaType = "application/json", schema = @Schema(implementation = PatientProfileDto.class)))
    })
    @GetMapping
    ...
    @Operation(summary = "Get patient profile by ID", description = "Retrieve a specific patient profile by its unique identifier")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Create new patient profile", description = "Create a new patient profile with the provided information")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Update patient profile", description = "Update an existing patient profile with new information")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Delete patient profile", description = "Delete a patient profile and all associated data")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Check if patient exists", description = "Check if a patient profile exists by ID")
    @ApiResponses(value = {
