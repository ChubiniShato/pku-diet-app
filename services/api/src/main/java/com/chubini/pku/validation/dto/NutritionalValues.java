...
public record NutritionalValues(
    ...
    public NutritionalValues add(NutritionalValues other) {
        return new NutritionalValues(
                this.pheMg != null && other.pheMg != null ? this.pheMg.add(other.pheMg) : 
                        (this.pheMg != null ? this.pheMg : other.pheMg),
                this.proteinG != null && other.proteinG != null ? this.proteinG.add(other.proteinG) : 
                        (this.proteinG != null ? this.proteinG : other.proteinG),
                this.kcal != null && other.kcal != null ? this.kcal.add(other.kcal) : 
                        (this.kcal != null ? this.kcal : other.kcal),
                this.fatG != null && other.fatG != null ? this.fatG.add(other.fatG) : 
