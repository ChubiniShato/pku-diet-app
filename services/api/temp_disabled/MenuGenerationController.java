...
@Tag(
    ...
    description = "APIs for automated menu generation using heuristic algorithms")
public class MenuGenerationController {

  private final MenuGenerationService menuGenerationService;

  @Operation(
      summary = "Generate weekly menu",
      description =
          "Generate a complete weekly menu using heuristic algorithm based on patient's nutritional requirements")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
            ...
            content =
                @Content(
                    ...
                    schema = @Schema(implementation = MenuGenerationResult.class))),
  ...
  @Operation(
      summary = "Generate daily menu",
      description =
          "Generate a single daily menu using heuristic algorithm based on patient's nutritional requirements")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
            description = "Daily menu generated successfully",
            content =
                @Content(
                    mediaType = "application/json",
                    schema = @Schema(implementation = MenuGenerationResult.class))),
  ...
  public ResponseEntity<MenuGenerationResult> generateDailyMenu(
      @Parameter(description = "Daily menu generation request", required = true) @Valid @RequestBody
          MenuGenerationRequest request) {
